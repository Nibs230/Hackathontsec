...
<div>
<h1 style="text-align: center; background-color: green; font-family : sans-serif;font-size: 35px; color: white;padding: 15px; text-decoration: underline;">How to apply to a University</h1>
</div>
<p style="font-family: sans-serif;font-size: 20px">
Feeling a surge of excitement as you view your very first online college application to pursue higher studies abroad? Quite a huge moment, we know, and there really is no reason for you to fear the application process — usually it is quite a straight-forward one. Currently, most Unis have their complete application processes online to make things quick and easy for international students. The actual application process will require you to register on the University's website and complete a step-wise application process. If you are sure about which programme you want to apply and have scanned copies of all relevant transcripts; then at the most, it will take you about 30 minutes to complete the application process
</p>
<h4 style=" font-family : sans-serif;font-size: 25px; color: green; text-decoration: underline;">For Starters</h4>
<p>One year ahead of when you would like to get your study abroad journey started, we advise you to start researching all options available. Start with the application process around six to eight months in advance. For those looking to get into study at the postgraduate level, this prepping process (that includes studying and taking tests like the GRE and TOEFL) should be on-going in your final year of college. For students looking to study abroad in the undergrad level, the right time for application to Unis will be at the mid of your twelfth grade. You will need to take care of taking the SAT in this year as well. For those of you who are below 18 years of age (UG level), we thought we’d give you a heads up — you will mostly require guardianship from a local citizen.</p>
<h4 style=" font-family : sans-serif;font-size: 25px; color: green; text-decoration: underline;">One Too Many!</h4>
<p>
...
<ul class="aa">
<li>Apply to a Uni that has slightly higher grades and scores for entry requirements, than what you have gotten. Apply only if you feel, after reading the admissions details, that there is hope of you landing an admit — even if it’s a bit of a long shot.</li>
<li>Apply to a Uni that has the kind of expected scores and grades that are in line with the ones that you have achieved.</li>
<li>Apply to a Uni that is sure to take you in, as their expected grades or scores are way below your achieved ones. This is your back-up option.</li>
</ul>
</p>
<h4 style=" font-family : sans-serif;font-size: 25px; color: green; text-decoration: underline;">Logging In!</h4>
<p>
...
<h4 style=" font-family : sans-serif;font-size: 25px; color: green; text-decoration: underline;">Your Academic Past!</h4>
<p>
The Uni will need you to submit your original transcripts or transcripts that are attested. For online applications, these will have to be scanned and uploaded within the form as required. Some Unis are particular that you send all your transcripts (be it from secondary school or college) for evaluation through international organizations such as World Education Services (WES), Education Credential Evaluators, Inc. (ECE), and International Education Research Foundation, Inc.(IERF). Make sure you follow the Uni’s directions carefully.</p>

<h4 style=" font-family : sans-serif;font-size: 25px; color: green; text-decoration: underline;">The Universal Tests!</h4>
<p>
...
<ul class="aa">
<li>550 (paper-based), 213 (computer-based) or 79 (internet-based)  for the TOEFL</li>
<li>A general score of above 2,000 works for the SAT</li>
<li>Roughly 149-153 (in your verbal), 158-160 (for your math), and 3.8 to 4.0 for the GRE</li>
<li>A score ranging from 550 and above for the GMAT</li>
<li>A band of around 5.5 – 7.0 will do for your IELTS</li>
</ul>

Again, these will vary from institution to institution so run a check on the Uni site to know the exact requirement.
</p>
<h4 style=" font-family : sans-serif;font-size: 25px; color: green; text-decoration: underline;">More About You!</h4>
<p>
...
<h4 style=" font-family : sans-serif;font-size: 25px; color: green; text-decoration: underline;">Word of Mouth!</h4>
<p>
